...
function goTo(fromId, toId) {
  ...
  // небольшая задержка, чтобы сначала увидели выход
  setTimeout(() => {
...
function goToPage2() {
  ...
  if (!val) { shakeInput('answer1'); return; }
  answers.q1 = val;
  goTo('page1', 'page2');
  setupYesButton();
}
...
/* ============================================================
   Q2 — убегающая кнопка «Да»
   ============================================================ */
let yesMoved = false;

function setupYesButton() {
  const btn = document.getElementById('yesBtn');
  // сначала разместим кнопку внутри карточки btn-group
...
function tryYes(e) {
  ...
  // При первом касании — переводим в fixed и начинаем убегать
...
function goToFinal() {
  ...
  if (!val) { shakeInput('answer3'); return; }
  answers.q3 = val;
...
/* ============================================================
   ...
   ============================================================ */
function goToAdmin() {
  document.getElementById('show1').textContent = answers.q1 || '—';
  document.getElementById('show2').textContent = answers.q2 || '—';
  document.getElementById('show3').textContent = answers.q3 || '—';
...
/* ============================================================
   SHAKE АНИМАЦИЯ ДЛЯ ПУСТОГО ВВОДА
   ============================================================ */
